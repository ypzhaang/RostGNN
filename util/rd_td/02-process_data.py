...
def main(args):
    ...
    data_folder = os.path.join(args.root_path, 'data')
    ...
    labels = reader.get_subject_score(subject_IDs, score='group')
    ...
    for i, subject in enumerate(subject_IDs):
        dd.io.save(os.path.join(data_folder,'raw',subject+"_"+str(i%3)+'.h5'),{'corr':fea_corr[i],'pcorr':fea_pcorr[i],'label':(y[i]-1)})
...
if __name__ == '__main__':
    ...
    parser.add_argument('--id_file_path', default="/mnt/5468e/ypzhang/LiYuxin/RD-TD/data/subject_repeat_IDs.txt", type=str, help='The path to subject_IDs.txt.')
